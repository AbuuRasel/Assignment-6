        ...
        <div className="flex flex-wrap gap-8 pb-12 md:gap-12">
          ...
          <div className="flex-1 min-w-[120px]">
            ...
            <div className="flex flex-wrap gap-2.5">
              ...
              <a href="https://www.facebook.com/raselmahmud2k2" target="_blank"
                rel="noopener noreferrer" className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#1e1e30] text-white transition-all duration-150 hover:-translate-y-0.5 hover:bg-[#8153d7]" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/raselmahmud2k2" target="_blank"
                rel="noopener noreferrer" className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#1e1e30] text-white transition-all duration-150 hover:-translate-y-0.5 hover:bg-[#8153d7]" aria-label="Facebook">
              ...
              <a href="https://www.facebook.com/raselmahmud2k2" target="_blank"
                rel="noopener noreferrer" className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#1e1e30] text-white transition-all duration-150 hover:-translate-y-0.5 hover:bg-[#8153d7]" aria-label="X">
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
